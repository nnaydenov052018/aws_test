...
class AwsEc2(object):
    ...
    def change_ec2_security_groups(self, instance_id=None, security_group_ids=None):
        try:
...
#ec2.create_ec2_security_group(security_group_name='devops-sec-group', ingress_port=22)
